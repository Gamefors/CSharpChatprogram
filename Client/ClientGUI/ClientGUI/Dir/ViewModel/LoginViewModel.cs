...
namespace ClientGUI.Dir.ViewModel
{
    class LoginViewModel : BaseViewModel
    {
        ...
        public LoginViewModel(MainWindowViewModel MainWindowViewModel, Action<bool> connectEvent_, Action<string> loginEvent_, Action<string> EnterPressEvent_)
        {
        ...
        private void LoginButtonAction(object parameter)
        {
            ...
            else
            {
                ...
                SClient client = new SClient(connectEvent, loginEvent, EnterPressEvent, MainWindowViewModel);
